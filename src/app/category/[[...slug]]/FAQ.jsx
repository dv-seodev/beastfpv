        ...
        <section className="faq">
            <div className="container faq__container">
                ...
                <details className="details">
                    ...
                    <div className="details__content">
                        <p>Подключение приемника осуществляется крестообразным типом. TX от приемника идет к RX на полетном контроллера. А RX от приемника идет к TX на полетном контроллере. Если вы подключите другим способом TX на TX и RX на RX - приемник работать не будет.</p>
                    </div>
                </details>
            </div>
        </section >
